pair<int,int> predecessorSuccessor(BinaryTreeNode<int>* root, int key)
{
    ...
    while(root){
        ...
        if(root->data > key){
            succ = root->data;   
  //If there is no right subtree to new root in next line, then previous
  //root is the successor.
    ...
    //If there is a left subtree, predecessor will be the
    ...
    //If there is a right subtree, successor will be the
